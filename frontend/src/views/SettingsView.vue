            ...
            <div class="space-y-6">
              ...
              <div class="bg-red-50 dark:bg-red-500/5 border border-red-100 dark:border-red-500/20 rounded-2xl p-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  ...
                  <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Deletes generated cache artifacts, including video transition frames. Original media files are never deleted.</p>
                </div>
