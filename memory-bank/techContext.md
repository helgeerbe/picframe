...
## Verification Notes
- Frontend build passes with `npm run build`; the 2026-06-19 #694 check emitted sandbox stream-fd warnings before Vite completed successfully.
- Backend pytest passes in the local Python 3.14.4 `.venv`: `.venv/bin/python -m pytest` reported 632 passed, 1 GI deprecation warning on 2026-06-19.
