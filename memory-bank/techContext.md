...
- Backend pytest now passes in the local Python 3.14.4 `.venv`: `.venv/bin/python -m pytest -q` reported 205 passed, 1 skipped, 1 GI deprecation warning on 2026-05-31.
