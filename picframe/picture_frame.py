...
def main():
    ...
    group.add_argument("-i", "--initialize",
                        help="creates standard file structure for picture_frame in destination directory",
    ...
    if args.initialize:
        ...
        try: 
            ...
            print('created ',args.initialize,'/picture_frame')
        except Exception as e:
            print("Can't copy files to: ", args.initialize, ". Reason: ", e)
        return
    elif args.version:
        print("picture_frame version: ", __version__)
