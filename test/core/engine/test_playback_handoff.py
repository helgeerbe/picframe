...
def test_video_handoff_sequence(
    ...
    mock_playlist_manager.get_current.return_value = MediaItem(
        id=1,
        filepath="/path/to/image1.jpg",
        filename="image1.jpg",
        directory_id=1,
    ...
    with (
        ...
        # The mock_playlist_manager.get_next has a side_effect, so we need to
        # modify the first item in the side_effect list
    ...
    # _current_media is not updated until the transition completes or we
    # fetch it from playlist manager
