...
def test_handle_file_change_image(
    ...
    # Setup
    event = FileChangeEvent(path="/test/image.jpg", event_type="created")
    ...
    # Assert
    mock_image_strategy.extract.assert_called_once_with("/test/image.jpg", 1)
...
def test_handle_file_change_video(
    ...
    # Setup
    event = FileChangeEvent(path="/test/video.mp4", event_type="created")
    mock_media_item = MediaItem(
    ...
    # Assert
    mock_video_strategy.extract.assert_called_once_with("/test/video.mp4", 1)
